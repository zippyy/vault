...
type Backend interface {
	...
	// a possibility.
	LogRequest(*logical.Auth, *logical.Request, *logical.AuditConfig, error) error
	...
	// MUST not be modified in anyway. They should be deep copied if this is
	// a possibility.
	LogResponse(*logical.Auth, *logical.Request, *logical.Response, *logical.AuditConfig, error) error
